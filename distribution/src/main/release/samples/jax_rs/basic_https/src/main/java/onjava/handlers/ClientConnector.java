...
import onjava.io.ConnectorSelectorHandler;
 ...
 * @author Nuno Santos
 */
final public class ClientConnector implements ConnectorSelectorHandler {
    ...
    /**
     * Creates a new instance. The connection is not attempted here. Use connect() to start the attempt.
     * 
     ...
     * @throws IOException
     */
    public ClientConnector(SelectorThread selector, InetSocketAddress remoteAddress, ConnectorListener listener) {
    ...
    public void connect() throws IOException {
        ...
        sc.connect(remoteAddress);   //connessione SYN  comincia qui

        // Registers itself to receive the connect event.
        selectorThread.registerChannelLater(sc, SelectionKey.OP_CONNECT, this, new CallbackErrorHandler() {
            public void handleError(Exception ex) {
                listener.connectionFailed(ClientConnector.this, ex);
            }
        });
    }
    ...
    public String toString() {
        return "Remote endpoint: " + remoteAddress.getAddress().getHostAddress() + ":"
