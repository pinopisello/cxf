...
final public class PacketChannel implements ChannelListener {
  /** The SSLChannel socket where read and write operations are performed. */
  private final ServerSocketChannel_IOHandler socketChannel_handler;
  ...
  public PacketChannel(SocketChannel sc,
  	...
  	this.socketChannel_handler = channelFactory.createSocketChannel_IOHandler(sc, st, this);
...
//    inBuffer.flip();
  ...
  public void handleRead() {
    try {      
      ...
      int readBytes = socketChannel_handler.packetChannelRead(inBuffer);      
//      System.out.println("Read: " + readBytes);
  ...
  public void disableReading() throws IOException {
  	socketChannel_handler.unregisterForRead();        
  }
  ...
  private void reactivateReading() throws IOException {
  	socketChannel_handler.registerForRead();
//    selector.addChannelInterestNow(channel, SelectionKey.OP_READ);
  ...
  private void requestWrite() throws IOException {
  	socketChannel_handler.registerForWrite();
//    selector.addChannelInterestNow(channel, SelectionKey.OP_WRITE);
  ...
  public void handleWrite() {    
    try {
      ...
      int written = socketChannel_handler.packetChannelWrite(outBuffer);
//      System.out.println("Wrote: " + written);
  ...
  public SocketChannel getSocketChannel() {
    return socketChannel_handler.getSocketChannel();
  }
  
  public String toString() {  
    return Integer.toString(socketChannel_handler.getSocketChannel().socket().getLocalPort());
  }
}